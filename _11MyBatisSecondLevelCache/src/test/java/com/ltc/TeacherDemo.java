...
public class TeacherDemo {
    ...
    /**
     * 1.[DEBUG] com.ltc.TeacherDemo 60 第一次从数据库中获取数据===》Teacher{tid=1, tName='老师2'}
     2. [DEBUG] com.ltc.dao.TeacherDao 62 Cache Hit Ratio [com.ltc.dao.TeacherDao]: 0.0
     3. [DEBUG] com.ltc.TeacherDemo 63 第二次从一级缓存中获取数据===》Teacher{tid=1, tName='老师2'}
     步骤：
     01.当我们查询id=1的老师信息时
