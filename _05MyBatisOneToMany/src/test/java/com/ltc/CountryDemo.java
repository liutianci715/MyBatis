...
public class CountryDemo {
        ...
        public void selectCountry(){
                Country country = dao.selectCountryByCid(1);
                log.debug(country);
        }
         ...
         * 根据国家的编号  查询出 国家对应省会的信息
         * 设置延迟加载
         *01.在mybatis核心配置文件中 增加setting节点
         *02.节点中增加
        ...
        public  void selectCountryLazy(){
                Country country = dao.selectCountryByCid(2);
                log.debug(country.getcId()); //只查询国家的名称  如果开启了延迟加载有1条sql
